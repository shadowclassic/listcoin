...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("ListCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  listcoind [options]                     " + "\n" +
                  "  listcoind [options] <command> [params]  " + _("Send command to -server or listcoind") + "\n" +
                  "  listcoind [options] help                " + _("List commands") + "\n" +
                  "  listcoind [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "listcoin:"))
                fCommandLine = true;
...
int main(int argc, char* argv[])
{
    ...
    // Connect listcoind signal handlers
    noui_connect();
