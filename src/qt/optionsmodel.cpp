...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::LIC).toInt();
    ...
    fAutoRedeemList = settings.value("fAutoRedeemList", false).toBool();
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemList: return "AutoRedeemList";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::LIC).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemList: {
            fAutoRedeemList = value.toBool();
            settings.setValue("fAutoRedeemList", fAutoRedeemList);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemList() { return fAutoRedeemList; }
