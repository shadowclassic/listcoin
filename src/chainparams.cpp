...
public:
    CBaseChainParams() {
        const char* pszTimestamp = "Russia suspends weapons-grade plutonium deal with US 03.10.2016";
        CTransaction txNew;
		...
		txNew.vout[0].nValue=10000000;
		txNew.vout[0].scriptPubKey = CScript() << ParseHex("03EE070FC396A6FC885F6246060C3DEAF066B85460A874AAE39D6BE6CB7BFDEED6") << OP_CHECKSIG;
...
*/
        ...
        assert(hashGenesisBlock == uint256("0x0000035c457b8df0f361820d75f13a32a540bafe19befdaec2113556a662d86c"));
        assert(genesis.hashMerkleRoot == uint256("0x2293a7f27b77100810ccb3cf53d4f37f616b00042901570c6d008253ea04ec18"));
...
*/
        ...
        assert(hashGenesisBlock == uint256("0x0000e6d59c72141530740e506a1a704956f3434d7c6bb07cb53fff84881ee300"));
...
*/
        ...
        assert(hashGenesisBlock == uint256("0x528ca93080ef04d9956a963566cf1cc435e18f1c9622ff6b51a38a84de0251de"));
